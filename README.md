...
[![GitHub Trends SVG](https://githubtrends.io](https://api.githubtrends.io/user/svg/NazifAltintas/langs?time_range=one_year&loc_metric=changed&theme=synthwaves))
